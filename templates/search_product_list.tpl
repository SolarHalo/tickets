...
<script type="text/javascript"> 
	...
	function load(data){
		//var data = {{$data}};
		var source  = eval('(' + '{{json_encode($data)}}' + ')');
		...
		<div class="content">
			<div class="events">
				...
				<div class="events-l mt15">
					...
					<!--       	<div class="img-sidebar" >	{{include file="map.tpl" }}</div> -->
				...
				<div class="events-c2">
					<div class=" gigs_k map">
						<span class="aigs_k_title" id="totalCounter">We have found
							{{$totalEvent}} events</span> <strong>sort By:</strong> <select
							name="" class="id_3">
						...
						<tr>
							<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										<td class="tdC">{{$d['week']}}<br /> <span>{{$d['date']}}</span><br />
											<font>{{$d['time']}}</font> <a href="#" class="time2">53
												Dates</a>
										</td>
										<td><a
