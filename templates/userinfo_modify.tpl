...
<div class="mian">
    <div class="content">
    	<div class="login-l login">
            ...
            <table> 
				<tr>
                    ...
                    <td><a href="#"><img src="images/layer-ioc.png" align="middle" style="padding:50px 0 0 10px;"/></a></td> 
                </tr>
                <tr>
        ...
        <div class="login-r login">
            ...
            <table class="mt15"> 
				<tr>
                    <td><a href="#" class="btn btn-black-2"><img src="images/layer-ioc.png" style="vertical-align: middle;" width="17" height="17"/>&nbsp;&nbsp;Manage Layers</a>
