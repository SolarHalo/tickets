		...
		$.post(
			...
			function(obj){
				var html = "<h1>" + obj.product_name +"</h1>" +
                    ...
                    "<p class=\"mt15\"><a href=\"javascript:addCalendat('"+obj.aw_product_id+"')\" class=\"btn btn-range\">Add to Calendar</a><a href=\"{{$smarty.const.WEBSITE_URL}}buyticket/index/?pid="+obj.aw_product_id+"\" class=\"back btn btn-black\"><strong>Buy Tickets</strong></a></p>" ;
				$("#info-show").html(html);
