                ...
                <ul class="nav pull-right">
				 ...
				 -->
					...
					<li id="fat-menu" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{$smarty.const.WEBSITE_URL}}admin/set/index/?t=default">默认模板</a></li>
                            <li><a href="{{$smarty.const.WEBSITE_URL}}admin/set/index/?t=blacktie">黑色领结</a></li>
                            <li><a href="{{$smarty.const.WEBSITE_URL}}admin/set/index/?t=wintertide">冰雪冬季</a></li>
							<li><a href="{{$smarty.const.WEBSITE_URL}}admin/set/index/?t=schoolpainting">青葱校园</a></li>
                        </ul>
                    </li>
