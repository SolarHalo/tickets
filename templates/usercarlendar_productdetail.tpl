...
<div id="tcbox">
  <div id="tccontent">
    <div class="row3 map gigs_tck"><span class="fl pl">Event Details</span><a href="#" class="fr pr">X</a></div>
    ...
    <div id="con">
      <ul id="tags">
        <li><a onClick="selectTag('tagContent0',this)"  href="javascript:void(0)">Map</a> </li>
        <li class=selectTag><a onClick="selectTag('tagContent1',this)" href="javascript:void(0)">Directions</a> </li>
      </ul>
      <div id="tagContent">
    ...
    <span class="fl"><a href="#" class="btn btn-blue btn-Calendar ml15">Edit</a><font><a href="#" class="cancel">cancel</a></font></span>
  ...
  <div class="content">
    <div class="events">
      <div class="gigs-1"> <span> <a href="#" class="fl btn btn-black-2">New Calendar Entry</a> <a href="#" class="fl btn btn-black-3">Export your Calendar</a></span>
        <p class=" mt15 gigs-top-xx fr"> <a href="#" class="btn-hs2 btn-Calendar left-by">Day</a> <a href="#" class="btn-hs2 btn-Calendar by-hover">Week</a> <a href="#" class="btn-hs2 btn-Calendar">Month</a> <a href="#" class="btn-hs2 btn-Calendar right-by">Agenda</a> </p>
      </div>
