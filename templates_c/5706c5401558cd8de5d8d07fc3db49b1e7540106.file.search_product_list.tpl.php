<?php /* Smarty version Smarty-3.1.13, created on 2013-11-06 21:32:58
...
<!-- 												src="<?php echo @constant('WEBSITE_URL');?>
public/photo/photo.gif" -->
<!-- 												width="160" height="265" alt="" /></a></li> -->
<!-- 										<li><a href="/" target="_blank"><img -->
<!-- 												src="<?php echo @constant('WEBSITE_URL');?>
public/photo/photo1.gif" -->
<!-- 												width="160" height="265" alt="" /></a></li> -->
<!-- 										<li><a href="/" target="_blank"><img -->
<!-- 												src="<?php echo @constant('WEBSITE_URL');?>
public/photo/photo2.gif" -->
<!-- 												width="160" height="265" alt="" /></a></li> -->
<!-- 										<li><a href="/" target="_blank"><img -->
<!-- 												src="<?php echo @constant('WEBSITE_URL');?>
public/photo/photo5.gif" -->
<!-- 												width="160" height="265" alt="" /></a></li> -->
<!-- 									</ul> -->
<!-- 								</div> -->
