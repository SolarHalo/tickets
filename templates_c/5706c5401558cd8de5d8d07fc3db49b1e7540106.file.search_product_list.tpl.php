<?php /* Smarty version Smarty-3.1.13, created on 2013-09-24 17:39:31
...
<title>Search4gigs Search – Music, tickets and cultural events on your
	calendar.</title>
...
login";
	...
	function load(data){
		//var data = <?php echo $_smarty_tpl->tpl_vars['data']->value;?>
;
		var source  = eval('(' + '<?php echo json_encode($_smarty_tpl->tpl_vars['data']->value);?>
' + ')');
		...
		<div class="content">
			<div class="events">
				...
				<div class="events-l mt15">
					...
					<!--       	<div class="img-sidebar" >	<?php echo $_smarty_tpl->getSubTemplate ("map.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</div> -->
					<div  style="width: 160px; height: 265px" class="img-sidebar">
